...
#include "../lvgl-qt-sim/sim/clabel.h"
...
QT_MOC_LITERAL(6, 41, 13) // "mouseReleased"

    },
    "ClickableLabel\0clicked\0\0mousePressed\0"
    "x\0y\0mouseReleased"
};
...
void ClickableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ClickableLabel::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickableLabel::mouseReleased)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void ClickableLabel::mousePressed(int _t1, int _t2)
{
...
// SIGNAL 2
void ClickableLabel::mouseReleased(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
